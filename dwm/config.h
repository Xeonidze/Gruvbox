...
static const char *fonts[] = {
    "JetBrains Mono:size=14",                 /* 1. Основной шрифт (задает высоту панели) */
    "JetBrainsMono Nerd Font:size=80",        /* 2. Шрифт для стрелок (увеличенный) */
    "monospace:size=10"                       /* 3. Запасной на всякий случай */
};
...
static char titleselbordercolor[]        = "#fe8019";
static char titleselfloatcolor[]         = "#fe8019";
...
static char hidnormfgcolor[]             = "#fe8019";
...
static const char *scrfullcmd[] = { "sh", "-c", "maim ~/Pictures/screen-$(date +%s).png", NULL };
static const char *scrclipcmd[] = { "sh", "-c", "maim -s | xclip -selection clipboard -t image/png", NULL };
...
{ MODKEY,                   XK_s, spawn, {.v = scrfullcmd } },
{ MODKEY|ShiftMask,         XK_s, spawn, {.v = scrclipcmd } },
};
